...
try
{
    ...
    var hints2 = new System.Collections.Generic.Dictionary<EncodeHintType, object>
    {
        [EncodeHintType.CHARACTER_SET] = "UTF-8",
        [EncodeHintType.QR_VERSION] = mine.Version,
        [EncodeHintType.QR_MASK_PATTERN] = mine.Mask,
    };
    var qr = ZXing.QrCode.Internal.Encoder.encode(text, ErrorCorrectionLevel.M, hints2);
